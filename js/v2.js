	...
	//下單POPUP STEP1
	function MarketOrder( marketid, selectid, TradingVol, marketname, selectname, profit, systemrate, price, fee )
	{
		console.log( 'MarketOrder( '+marketid+', '+selectid+', '+TradingVol+', '+marketname+', '+selectname+', '+profit+', '+systemrate+', '+price+', '+fee+' )');
