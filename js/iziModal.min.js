...
(function (e) {
	...
	a.prototype = {
		...
		close: function (t) {
			function a() {
				l.options.iframe === !0 && l.$element.find("." + i + "-iframe").attr("src", ""), (l.options.bodyOverflow || o) && e(document.body).css("overflow", "initial"), e(document.body).removeClass(i + "-attached"), l.$element.trigger(n.CLOSED), l.state = n.CLOSED, console.info("[ " + i + " | " + l.id + " ] Closed."), l.options.onClosed.call(this)
			}
			var l = this;
		...
		recalculateLayout: function () {
			...
			this.$element.css("margin-top") != o && this.$element.css("margin-top", o)
		}
	}, e.fn[i] = function (t, n) {
